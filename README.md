...
All animations generated by [`scripts/make_comparison_gif.py`](scripts/make_comparison_gif.py)
on a DGX Spark (GB10). Cell colors follow the official DREAMPlace scheme:
movable cells blue, fixed cells/macros red, fillers hidden.
